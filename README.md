...
`title`, `subject`, `heading`, `headline` — заголовок

`subtitle` — подзаголовок

`caption` — подпись к иллюстрирующему элементу (фото, чертежу, диаграмме, таблице); в отличие от заголовка часто располагается снизу или справа
...
`features` — список основных особенностей товара, услуги
...
`overlay` — полупрозрачное затенение, подстилаемое под модальные окна

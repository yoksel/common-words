...
`layout` — элемент, отвечающий за раскладку страницы (другого элемента)

`grid` — раскладка страницы (элемента) в виде сетки (обычно содержит в себе `row` и `col`, описанные ниже) 
...
`sidebar`, `aside` — боковая часть (страницы или элемента)

...
`tiny` — экран совсем малой ширины

`small`, `narrow` — экран малой ширины

`medium` — экран средней ширины

`large` — широкий экран

`huge` — очень широкий экран
...
`advertisement`, `adv`, `commercial`, `promo` — рекламный блок
